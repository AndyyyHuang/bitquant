...
from bitquant.utils.config import get_config, check_config
...
class BaseMinerNeuron(BaseNeuron):
    ...
    def _prompt(self, synapse: StreamingTradeHistory) -> StreamingTradeHistory:
        """
    ...
    @abstractmethod
    def prompt(self, synapse: StreamingTradeHistory) -> StreamingTradeHistory:
        """
